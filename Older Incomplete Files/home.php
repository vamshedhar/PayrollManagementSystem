...
if($_POST['hid'] == "nu_employee")
	{
		$insert_empnewquery = "insert into empdetails set emp_no = '$_POST[emp_no]', emp_name = '$_POST[emp_name]',  emp_desig = '$_POST[emp_desig]',  emp_bankacno = '$_POST[emp_bankacno]',  date_birth = '$_POST[date_birth]' , date_appoint = '$_POST[date_appoint]', emp_jis = '$_POST[emp_jis]', emp_category = '$_POST[emp_category]', pen_sch = '$_POST[pen_sch]', res_status = '$_POST[res_status]'";
...
{
	$da = round(0.35*($_POST['basic_pay'] + $_POST['grade_pay']));
...
<tr><td colspan="5"><hr width="98%" noshade="noshade" color="#000000" align="center" /></td></tr>
<tr>
<form name="salary_slip_view" action="salary_slip_report.php" enctype="multipart/form-data" method="post" target="_self">
