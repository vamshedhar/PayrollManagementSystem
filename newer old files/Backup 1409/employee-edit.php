<form name="primaryinput" method="post" action="formsubmit.php" enctype="text/plain" target="_self" title="">
	...
	<tr>
		...
		<table width="100%" align="center" cellpadding="2" cellspacing="0" border="1" bgcolor="#CCCCCC" bordercolor="#999999">
            ...
            <tr>
            	...
            	<td class="normal"><input disabled="disabled" type="text" size="20" maxlength="40" class="normal" name="emp_no" value="<?php echo($_POST['emp_no']); ?>" /></td>
            </tr>
            <tr>
        ...
        <table width="100%" align="center" cellpadding="2" cellspacing="0" border="1" bgcolor="#CCCCCC" bordercolor="#999999">
            <tr>
            	...
            	<td class="normal" width="60%"><input type="text" disabled="disabled" size="20" maxlength="40" class="normal" name="date_join" value="<?php echo($_POST['date_join']); ?>"/></td>
            </tr>
            <tr>
            	<td class="normal">Date Of Birth</td>
            	<td class="normal"><input type="text" disabled="disabled" size="20" maxlength="40" class="normal" name="date_birth" value="<?php echo($_POST['date _birth']); ?>" /></td>
            </tr>
            <tr>
