...
$acc_query = "select * from accounts where emp_no = '$_POST[emp_no]'";
...
<form name="primaryinput" method="post" enctype="multipart/form-data" target="_self" action="formsubmit.php">
