...
if($num == 1)
{
	echo "<script type='text/javascript'>window.location = 'error.php?id=2&err=exists';</script>";
...
<tr>
	<td class="normal" align="center"><input name="submit" type="submit" class="normal" value="Submit" size="10" />
